...
------------------------------------------------------------------------
We can also observe what our trace plots would look like under less ideal conditions. For example, what would happen if we chose a starting value that was very far away from our true $a$ and $b$?
