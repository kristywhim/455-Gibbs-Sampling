...
Since we already know that $(a_0, b_0)$ are the "correct" values for $(a,b)$, we can predict that our Gibbs sampling will fluctuate around these values.
